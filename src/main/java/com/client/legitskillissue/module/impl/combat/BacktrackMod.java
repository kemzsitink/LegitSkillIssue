...
public class BacktrackMod extends Module {
    ...
    // field_149072_a = posX (S14PacketEntity) — SAI, không phải entityId
    // Đúng theo fields.csv: field_149059_a = entityId (S14PacketEntity)
    private static final Field S14_ENTITY_ID = ReflectionUtil.findField(
            S14PacketEntity.class, "entityId", "field_149059_a");
