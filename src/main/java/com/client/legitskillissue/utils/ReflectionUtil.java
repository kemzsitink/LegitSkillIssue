...
public final class ReflectionUtil {
    ...
    public static Field findField(Class<?> clazz, String... names) {
        ...
        System.out.println("[LegitSkillIssue] ReflectionUtil: could not find field in " + clazz.getSimpleName() + " tried: " + java.util.Arrays.toString(names));
        return null;
    }
    ...
    public static Method findMethod(Class<?> clazz, String... names) {
        ...
        System.out.println("[LegitSkillIssue] ReflectionUtil: could not find method in " + clazz.getSimpleName() + " tried: " + java.util.Arrays.toString(names));
        return null;
    }
